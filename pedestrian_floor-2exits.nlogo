...
People use the gravity model (always flow to lower elevation, if space is available) to move to the exit.
...
A Rainfall model I built before: https://github.com/YangZhouCSS/Rainfall_Model

Grand Canyon in the models library.
@#$#@#$#@
default
true
0
